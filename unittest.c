...
void testGetFileNuFromMani(){
    FolderStructureNode *test_node = ConstructStructureFromFile("client/test_checkout/.Manifest");
    printf("The file num of client/test_checkout is %d\n", GetFileNumFromMani(test_node));
}

int main(){
    // testGetFileNuFromMani();
    // testGetMD5FileInfo();
    // testIsProject();
    // testinsert();
    // testSendFile();
